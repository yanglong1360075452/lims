...
public class TaskDto extends BaseDto implements Comparable<TaskDto> {
    ...
    private List<TaskSampleDto> taskSamples;
    ...
    public WfCfgWfDto getWorkflow() {
        return workflow;
    }

    public void setWorkflow(WfCfgWfDto workflow) {
    ...
    public List<TaskSampleDto> getTaskSamples() {
        return taskSamples;
    }

    public void setTaskSamples(List<TaskSampleDto> taskSamples) {
