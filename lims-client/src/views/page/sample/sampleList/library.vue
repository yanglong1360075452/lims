                ...
                <el-form label-position="right">
                    ...
                    <table class="table" v-noDataShow>
                        ...
                        <tr v-for="(list, $index) in tableDataList">
                            ...
                            <td>{{list.libraryIndex}}</td>
                            <td>{{list.deliverQuality}}</td>
                            <td>{{list.deliverConcentration}}</td>
                            <td>{{list.initVolume}}</td>
                            <td>{{list.actualConcentration}}</td>
                            <td>{{list.surplusVolume}}</td>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                filter: {
                    sampleCategory:[13,15],//DNA/RNA文库
                    sampleStatus: null,
